...
import {
  ...
  FileText, CheckSquare, HelpCircle, Bookmark, Target, LayoutList, FileSignature
} from 'lucide-react';
...
export function JobDesktopDetails({ job }: JobDesktopDetailsProps) {
    ...
    const allOtherSections = [
        job.availablePositions && { id: 'availablePositions', icon: Briefcase, title: "المناصب المتاحة", content: <FormattedText text={job.availablePositions} /> },

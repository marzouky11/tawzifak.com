      ...
      <div className="container mx-auto max-w-5xl px-4 pb-12">
        <Card>
          ...
          <CardContent className="prose prose-lg dark:prose-invert max-w-none prose-p:leading-relaxed prose-headings:text-green-600 prose-a:text-primary pt-0 md:pt-2">
            ...
            <h3 className="text-xl font-bold mt-6 mb-3 text-green-600">5. الحماية من الرسائل المزعجة والروبوتات (Cloudflare Turnstile)</h3>
            <p>
              نستخدم في منصة "توظيفك" خدمة Cloudflare Turnstile للتحقق من أن النماذج (مثل إنشاء حساب، تسجيل الدخول، نشر إعلان باحث عن عمل، إرسال رسالة، إضافة رأي، والإبلاغ عن إعلان) يتم إرسالها من قِبل مستخدمين حقيقيين وليس من قِبل برامج آلية أو روبوتات، وذلك لمنع إساءة الاستخدام والرسائل المزعجة والحفاظ على أمان المنصة لجميع المستخدمين. تعمل هذه الخدمة أحيانًا في وضع غير ظاهر للمستخدم (Invisible) دون الحاجة لأي تفاعل إضافي منك. لمزيد من المعلومات حول كيفية عمل هذه الخدمة والبيانات التي تعالجها Cloudflare، يمكنك الاطلاع على{' '}
            ...
            <h3 className="text-xl font-bold mt-6 mb-3 text-green-600">6. حقوقك وخياراتك</h3>
            <p>
            ...
            <h3 className="text-xl font-bold mt-6 mb-3 text-green-600">7. خصوصية الأطفال</h3>
            <p>
            ...
            <h3 className="text-xl font-bold mt-6 mb-3 text-green-600">8. التغييرات على سياسة الخصوصية</h3>
            <p>
            ...
            <h3 className="text-xl font-bold mt-6 mb-3 text-green-600">9. الاتصال بنا</h3>
            <p>

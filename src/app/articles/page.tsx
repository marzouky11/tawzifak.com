...
export const metadata: Metadata = {
  title: 'مقالات الفرص المهنية - شروحات عملية',
  description: 'دليل شامل يضم فرص العمل الدولية، الهجرة والتطوع، إلى جانب شروحات عملية حول التوظيف، القوانين المهنية، ومتطلبات العمل محليًا ودوليًا.',
};
